"""Pure helpers for generating per-hero ability override files (Dota 2 - Meme Mode)."""
...
BEGIN = "// === MEME MODE PER-HERO ABILITIES BEGIN (generated by tools/) ==="
END = "// === MEME MODE PER-HERO ABILITIES END ==="
